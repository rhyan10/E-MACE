...
def build_default_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--n_energies",
        help="number of excited state energy levels",
        type=int,
        default=3,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--nacs_key",
        help="Key of nacs in training xyz",
        type=str,
        default="smooth_nacs",
    )
    parser.add_argument(
        "--coeff_key",
        help="Key of coeff in training xyz",
        type=str,
        default="coeff",
    )
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "energy_forces_nacs_dipole",
        ],
    )
    parser.add_argument(
        "--forces_weight", help="weight of forces loss", type=float, default=90.0
    )
    parser.add_argument(
        "--swa_forces_weight",
    ...
    parser.add_argument(
        "--energy_weight", help="weight of energy loss", type=float, default=10.0
    )
    parser.add_argument(
        "--swa_energy_weight",
    ...
    parser.add_argument(
        "--nacs_weight", help="weight of nacs loss", type=float, default=1.0
    )
    parser.add_argument(
        "--coeff_weight", help="weight of coeff loss", type=float, default=1.0
    )
    parser.add_argument(
        "--swa_nacs_weight",
        help="weight of nacs after starting swa",
        type=float,
        default=1.0,
    )
    parser.add_argument(
        "--swa_coeff_weight",
        help="weight of coeff after starting swa",
        type=float,
        default=1.0,
    )
    parser.add_argument(
